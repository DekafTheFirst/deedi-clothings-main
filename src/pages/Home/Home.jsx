    ...
    <div className="home">
      ...
      <div className="hero">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className='blob-1' viewBox="26.57 62.33 143.6 98.19">
          <path fill="#707070" d="M65.8,-31.5C75.7,-20.8,67.6,6.8,53.6,26.8C39.6,46.7,19.8,59.2,-2.2,60.4C-24.2,61.7,-48.3,51.8,-61.7,32.1C-75.1,12.4,-77.8,-17,-65.7,-28.9C-53.6,-40.8,-26.8,-35.2,0.6,-35.6C27.9,-35.9,55.8,-42.1,65.8,-31.5Z" transform="translate(100 100)"></path>
        </svg>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-5 col-sm-6 image">
              ...
              <OptimizedImage src="/img/hero-img-cutout-trim.png" className='img' />
